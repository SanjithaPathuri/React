      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {loading ? (
          ...
          <div>
            ...
            <BarCharts
              title={`Bar Chart of Monthly Created Issues for ${repository.value} in last 2 years`}
              data={githubRepoData?.created}
            />
            {/* Render barchart component for a monthly created issues for a selected repositories*/}
            <BarCharts
              title={`Bar Chart of Weekly Closed Issues for ${repository.value} in last 2 years`}
              data={githubRepoData?.closed_weekly}
            />
            
            
            <LineCharts  
              title={`Line Chart of Monthly Created Issues for ${repository.value} in last 2 years`} 
              data={githubRepoData?.created}  
            />  
            <LineCharts 
              title={`Line Chart of Monthly Closed Issues for ${repository.value} in last 2 years`}  
            ...
            <StackBarCharts 
              title={`Stack-Bar chart of created and Closed Issue for ${repository.value} in last 2 years`}  
              data={githubRepoData?.created}  
